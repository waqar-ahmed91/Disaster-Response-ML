...
def index():
    ...
    category_counts = []
    for i in category:
        category_counts.append(np.sum(df[i]))
    ...
    largest_category = categories_counts.nlargest(5)
    largest_categoty_names = list(largest_category.index) 
